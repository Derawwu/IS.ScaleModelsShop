...
public class GetProductByManufacturerTests
{
    ...
    {
        Action result = () =>
            new GetProductsByManufacturerQueryHandler(_mapper, null, _manufacturerRepositoryMock.Object);
    ...
    {
        Action result = () =>
            new GetProductsByManufacturerQueryHandler(null, _productRepositoryMock.Object,
                _manufacturerRepositoryMock.Object);
    ...
    public async Task Handler_WhenCalled_AnyShouldBeCalled()
    {
        ...
        _manufacturerRepositoryMock.Verify(
            x => x.AnyAsync(It.IsAny<Expression<Func<Domain.Entities.Manufacturer, bool>>>()), Times.Once);
    }
