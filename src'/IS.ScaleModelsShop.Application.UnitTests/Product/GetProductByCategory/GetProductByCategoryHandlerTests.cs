...
public class GetProductByCategoryHandlerTests
{
    ...
    {
        Action result = () =>
            new GetProductsByCategoryQueryHandler(null, _productRepositoryMock.Object, _categoryRepositoryMock.Object);
    ...
    public async Task Handler_WhenCalled_AnyShouldBeCalled()
    {
        ...
        _categoryRepositoryMock.Verify(x => x.AnyAsync(It.IsAny<Expression<Func<Domain.Entities.Category, bool>>>()),
            Times.Once);
    }
