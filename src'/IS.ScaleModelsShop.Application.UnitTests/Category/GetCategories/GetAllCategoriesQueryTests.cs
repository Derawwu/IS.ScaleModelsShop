...
namespace IS.ScaleModelsShop.Application.UnitTests.Category.GetCategories
{
    public class GetAllCategoriesQueryTests
    {
        ...
        public void Setup()
        {
            ...
            _getAllCategoriesListQueryHandler = new GetAllCategoriesListQueryHandler(_mapper, _categoryRepositoryMock.Object);
        }
        ...
        {
            _categoryRepositoryMock.Setup(x => x.GetAllAsync()).ReturnsAsync(new List<Domain.Entities.Category>() { new Domain.Entities.Category() }.AsEnumerable());
