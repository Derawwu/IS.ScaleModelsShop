...
public class NotFoundMiddlewareTests
{
    ...
    public async Task Invoke_ValidationExceptionThrown_ResponseHandlerShouldBeCalled()
    {
        ...
        var notFoundExceptions = new EntityNotFoundException(errorMessageName, errorMessageKey);
        ...
        _mockResponseHandler.Verify(x => x.HandleResponseAsync(It.IsAny<HttpContext>(), It.IsAny<EntityNotFoundException>(), It.IsAny<ExceptionResponse>()), Times.Once);
    }
}